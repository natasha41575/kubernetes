...
const (
	...
	// allocated resources != acknowledged resources. If both PodResizePending and
	// PodResizeInProgress are set, it means that a new resize was requested in the middle of a previous
	// pod resize that is still in progress.
