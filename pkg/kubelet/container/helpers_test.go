	...
	tests := []testCase{
		{
			...
			&v1.Container{
				...
				ResizePolicy: []v1.ContainerResizePolicy{cpuPolicyRestartRequired, memPolicyPreferNoRestart},
			},
			0x11a6d6d6,
		},
		{
			...
			&v1.Container{
				...
				ResizePolicy: []v1.ContainerResizePolicy{cpuPolicyPreferNoRestart, memPolicyRestartRequired},
			},
			0x11a6d6d6,
		},
		{
