...
func TestEmptyDirLimitEviction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			enableGate:     false,
			actualCapacityBytes:  ptr.To(uint64(3 * 1024 * 1024 * 1024)), // 3Gi stat capacity (ignored)
		...
		},
		{
			...
			medium:         v1.StorageMediumMemory,
			enableGate:     false,
			actualCapacityBytes:  ptr.To(uint64(500 * 1024 * 1024)),
		...
		},
		{
			...
			medium:         v1.StorageMediumMemory,
			enableGate:     true,
			actualCapacityBytes:  ptr.To(uint64(3 * 1024 * 1024 * 1024)), // 3Gi stat capacity (respected)
